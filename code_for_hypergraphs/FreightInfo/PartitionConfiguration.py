...
def PartitionConfigurationAddEdgePartition(builder, edgePartition):
    builder.PrependInt32Slot(3, edgePartition, 0)

def AddEdgePartition(builder, edgePartition):
    PartitionConfigurationAddEdgePartition(builder, edgePartition)
